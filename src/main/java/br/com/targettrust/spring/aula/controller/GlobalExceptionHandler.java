...
import br.com.targettrust.spring.aula.model.error.MessageCode;
...
public class GlobalExceptionHandler {
    ...
    public ApiError notFoundException(NotFoundException ex) {
        ...
        return ApiError.of(ex.getMessage(), MessageCode.REGISTRY_NOT_FOUND);
    }
    ...
    public ApiError domainException(DomainException ex) {
        ...
        return ApiError.of(ex.getMessage(), ex.getMessage(), ex.getStackTrace());
    }
